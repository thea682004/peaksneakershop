...
import { faPen, faLayerGroup } from '@fortawesome/free-solid-svg-icons';
...
function Category() {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text, record, index) => (
                <React.Fragment key={index}>
                    <Button key={index} style={{ backgroundColor: '#1e3a8a', borderColor: '#1e3a8a' }} type="primary" onClick={() => showModal(record)}>
