        ...
        if (date) {
            ...
            axios.get(`${baseUrl}/statistical/product/topsale?startdate=${date[0].add(1, 'day').toISOString()}&enddate=${date[1].add(1, 'day').toISOString()}`).then(res => {
                if (res.data) {
                    ...
                    if (document.getElementById('myDivx')) {
        ...
        <div className='flex flex-col gap-5'>
            <div className='flex flex-col gap-3 bg-white shadow-lg p-6'>
                <div>
                    <p className='text-2xl font-semibold mb-3'>
                        <FontAwesomeIcon icon={faChartLine} style={{ marginRight: '10px' }} /> Thống kê
                    </p>
            ...
            <div className='bg-white shadow-lg p-6'>
                <div className='grid grid-cols-2 max-xl:grid-cols-1'>
                    ...
                    <div>
                        <p className='text-[18px] font-bold text-center mb-3'>Biểu đồ sản phẩm bán chạy</p>
                        <div id="myDivx"></div>
                    </div>
                </div>
            </div>
